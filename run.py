...
def main():
    ...
    if not os.path.exists('manage.py'):
        print("❌ Ошибка: файл manage.py не найден. Убедитесь, что вы находитесь в корневой папке проекта.")
        return
    ...
    print("\nДля запуска всех компонентов выполните следующие команды в разных терминалах:")
    print("\n1. Django сервер:")
